...
// @astrojs/sitemap: that integration does not understand build.format
// 'preserve' and strips the .html from the documentation URLs, so 27 of the 33
// entries pointed at pages that do not exist.
